...
public partial class CalculatorParser : Parser {
	public const int
		LPAREN=1, RPAREN=2, INT=3, MUL=4, DIV=5, ADD=6, SUB=7, WS=8;
	public const int
	...
	private static readonly string[] _SymbolicNames = {
		null, "LPAREN", "RPAREN", "INT", "MUL", "DIV", "ADD", "SUB", "WS"
	};
	...
	public partial class MulDivContext : ExprContext {
		...
		public ITerminalNode MUL() { return GetToken(CalculatorParser.MUL, 0); }
